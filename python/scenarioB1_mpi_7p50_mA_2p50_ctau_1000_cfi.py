...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 30.0              ! dark confinement scale",
            "HiddenValley:pTminFSR = 33.0        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 30.84231625282781          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 31.03268374717219          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 7.5                        ! Setting pion Mass",
            "4900211:m0 = 7.5                        ! Setting pion Mass",
            "4900221:m0 = 30.0                        ! Setting eta Mass",
            "4900113:m0 = 30.0                       ! Setting rho Mass",
            "4900213:m0 = 30.0                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "999999:all = GeneralResonance void 1 0 0 2.5 0.001 0. 0. 0.        ! dark photon A'",
            ...
            "999999:tau0 = 7.089999999999999e-10                            ! proper lifetime, in mm",
