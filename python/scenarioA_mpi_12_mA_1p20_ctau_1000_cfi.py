...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:Lambda = 48              ! dark confinement scale",
            "HiddenValley:pTminFSR = 52.800000000000004        ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 49.3477060045245          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900102:m0 = 49.6522939954755          ! Dark Quark Mass, following arXiv:2203.09503",
            "4900111:m0 = 12                        ! Setting pion Mass",
            "4900211:m0 = 12                        ! Setting pion Mass",
            "4900221:m0 = 48                        ! Setting eta Mass",
            "4900113:m0 = 48                       ! Setting rho Mass",
            "4900213:m0 = 48                       ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 1.2 0.001 0. 0. 0.        ! dark photon A'",
            "9900015:addChannel = 1 0.343 91 11 -11              ! A' -> e+ e-",
            "9900015:addChannel = 1 0.343 91 13 -13              ! A' -> mu+ mu-",
            "9900015:addChannel = 1 0.0887 91 211 -211              ! A' -> pi+ pi-",
            "9900015:addChannel = 1 0.041 91 321 -321              ! A' -> K+ K-",
            "9900015:addChannel = 1 0.024 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "9900015:addChannel = 1 0.0471 91 211 -211 211 -211              ! A' -> pi+ pi- pi+ pi-",
            "9900015:addChannel = 1 0.0935 91 211 -211 111 111              ! A' -> pi+ pi- pi0 pi0",
            ...
            "4900111:tau0 = 9.15e-05                            ! proper lifetime, in mm",
            "4900211:onMode = 0",
        ),
