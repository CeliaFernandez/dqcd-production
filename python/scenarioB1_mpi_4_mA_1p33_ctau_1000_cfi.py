...
generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "999999:all = GeneralResonance void 1 0 0 1.3333333333333333 0.001 0. 0. 0.        ! dark photon A'",
            "999999:addChannel = 1 0.305 91 11 -11              ! A' -> e+ e-",
            "999999:addChannel = 1 0.305 91 13 -13              ! A' -> mu+ mu-",
            "999999:addChannel = 1 0.043 91 211 -211              ! A' -> pi+ pi-",
            "999999:addChannel = 1 0.0394 91 321 -321              ! A' -> K+ K-",
            "999999:addChannel = 1 0.0229 91 211 -211 111              ! A' -> pi+ pi- pi0",
            "999999:addChannel = 1 0.107 91 211 -211 211 -211              ! A' -> pi+ pi- pi+ pi-",
            "999999:addChannel = 1 0.14 91 211 -211 111 111              ! A' -> pi+ pi- pi0 pi0",
            "999999:tau0 = 1.86e-09                            ! proper lifetime, in mm",
